...
def login():
    ...
    loginlabel = Label(loginwindow, text = 'Login Page')
    accountlabel = Label(loginwindow, text ='Account')
    passwordlabel = Label(loginwindow, text ='Password')
    resultLabel = Label(loginwindow, text = "")
    #創建帳號和密碼愉入框
    accountentry = Entry(loginwindow)
    passwordentry = Entry(loginwindow, show="*")
    #密飛喻入會顯示為星號
    signUpbutton = Button(loginwindow, text ='Sign Up', width=10, command=lambda: addUser(loginwindow, accountentry, passwordentry))
    loginbutton = Button(loginwindow, text = 'Log in', width=10, command=lambda: verifyUser (loginwindow, accountentry, passwordentry))
#放置元件
...
def thenew():
    ...
    bannerImage2=Image.open('img/Orange Modern Special Offer Big Sale Facebook Ad.png')
...
bannerImage=Image.open('img/Orange Modern Special Offer Big Sale Facebook Ad.png')
...
sofa1Image=Image.open('img/Screenshot 2022-12-17 at 13.04.27.png')
...
sofa2Image=Image.open('img/Screenshot 2022-12-17 at 12.54.20.png')
...
sofa3Image=Image.open('img/Screenshot 2022-12-17 at 13.08.00.png')
...
sofa4Image=Image.open('img/Screenshot 2022-12-17 at 13.13.35.png')
...
chartImage=Image.open('img/Shopping Cart.png')
